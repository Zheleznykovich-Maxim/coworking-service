...
public class BookingQuery {
    ...
    public static final String UPDATE_BOOKING = "UPDATE coworking.bookings SET user_id = ?, resource_id = ?, resource_name = ?, start_time = ?, end_time = ?, resource_type = ?, is_available = ? WHERE id = ?";
